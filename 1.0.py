...
url_windowicon = "https://user-images.githubusercontent.com/63937252/206831507-2b362a52-9cfe-4679-ac93-72399f73d18d.png"
req.urlretrieve(url_windowicon, "testicon.png")
baseGround.tk.call('wm', 'iconphoto', baseGround._w, tk.PhotoImage(file = "testicon.png"))
...
def About_Osaifu():
    ...
    url_windowicon = "https://user-images.githubusercontent.com/63937252/206831507-2b362a52-9cfe-4679-ac93-72399f73d18d.png"
    req.urlretrieve(url_windowicon, "testicon.png")
    Pop_About.tk.call('wm', 'iconphoto', Pop_About._w, tk.PhotoImage(file = "testicon.png"))
    url = "https://user-images.githubusercontent.com/63937252/206831507-2b362a52-9cfe-4679-ac93-72399f73d18d.png"
    req.urlretrieve(url, "test.png")
    img = Image.open('test.png')
    img = ImageTk.PhotoImage(img)
    img = tk.PhotoImage(file='test.png', width=800, height=800)
    img = img.subsample(4)
